...
class NewMedicine2Controller: UITableViewController{
    ...
    @IBOutlet var photoImageView2: UIImageView! {
        didSet {
            photoImageView2.layer.cornerRadius = 10.0
            photoImageView2.layer.masksToBounds = true
        }
    }
}

// 當使用者從照片庫選擇一張照片後，呼叫此方法取得所選取的照片
extension NewMedicine2Controller: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
